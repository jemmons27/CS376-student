...
public class Enemy : MonoBehaviour
{
    ...
    private void Fire()
    {
        ...
        var dir = new Vector3(HeadingToPlayer.x, HeadingToPlayer.y, 0);

        GameObject newOrb = Instantiate(OrbPrefab, pos + dir, rigidBody.transform.rotation);

        var RB_Orb = newOrb.GetComponent<Rigidbody2D>();
        RB_Orb.velocity = HeadingToPlayer * OrbVelocity;
        RB_Orb.mass = OrbMass;
    }
